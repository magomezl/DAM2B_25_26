...
//			System.out.println(handle.getLista());
	...
	private static void generarExcel(List<AlumnoDTO> lista) throws FileNotFoundException, IOException {
		Workbook libro = new XSSFWorkbook();
		Sheet hoja = libro.createSheet();
		
		String[] cabecera = {
				"ID Alumno", "Nombre", "Curso", "Cuota Mensual",
				"Número de Cuenta", "Banco", "Total Pagado",
				"Total Pendiente", "Cuotas Pendientes"
		};
